...
/**
 * UniversalComparator is a utility class that compares two XML or JSON files.
 * - Supports XML element and attribute comparisons.
 * - Supports JSON key-value and nested object comparisons.
 * - Generates a structured diff report using DiffResult.
 */
public class UniversalComparator {
    ...
    public static DiffResult compareXMLFiles(String shortName1, Path file1, String shortName2, Path file2, List<String> ignoredTags) throws Exception {
        ...
        // Maps for XML structure and attributes
